...
const eightBall = ["It is certain.", "Without a doubt.", "Ask again later.", "Better not tell you now.", "My sources say no."];
...
const commands = [
    ...
    new SlashCommandBuilder()
        ...
        .addUserOption(o => o.setName('target').setDescription('The user to view').setRequired(true)),
    ...
    new SlashCommandBuilder()
        ...
        .addUserOption(o => o.setName('target').setDescription('The user to inspect').setRequired(true)),

    new SlashCommandBuilder()
        .setName('poll')
        .setDescription('Create a simple poll')
        .addStringOption(o => o.setName('question').setDescription('The topic').setRequired(true))
        .addStringOption(o => o.setName('opt1').setDescription('First option').setRequired(true))
        .addStringOption(o => o.setName('opt2').setDescription('Second option').setRequired(true))
    ...
    try {
        if (commandName === 'help') {
            const embed = new EmbedBuilder()
                ...
                .setDescription('I am your friendly neighborhood bot! Type `/` to see my commands.\n\nHighlights: `/joke`, `/poll`, `/roll`, `/meme`');
            ...
            await interaction.reply(user.displayAvatarURL({ size: 512, dynamic: true }));
        }
